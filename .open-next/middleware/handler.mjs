      ...
      function a7(a10, b10, c10) {
        ...
        return a10 instanceof RegExp ? function(a11, b11) {
          ...
          for (var d11 = c11.strict, e10 = void 0 !== d11 && d11, f10 = c11.start, g10 = c11.end, h2 = c11.encode, i2 = void 0 === h2 ? function(a12) {
            return a12;
          } : h2, j2 = c11.delimiter, k2 = c11.endsWith, l2 = "[".concat(a5(void 0 === k2 ? "" : k2), "]|$"), m2 = "[".concat(a5(void 0 === j2 ? "/#?" : j2), "]"), n2 = void 0 === f10 || f10 ? "^" : "", o2 = 0; o2 < a11.length; o2++) {
            var p2 = a11[o2];
...
Clerk Trace ID: ${this.clerkTraceId}`), a11;
      ...
      var cc = /* @__PURE__ */ ((a10, b10) => function() {
        ...
        return f10 && (h2 && f10.searchParams.delete(ci.QueryParameters.ClerkSynced), g10.searchParams.set("redirect_url", f10.toString())), h2 && d10 && g10.searchParams.set(ci.QueryParameters.DevBrowser, d10), g10.toString();
      }, ck = (a10, b10) => {
        let c10;
      ...
      }, dM = (a10) => "object" == typeof a10 && null !== a10, dN = (a10) => dM(a10) && !(a10 instanceof RegExp) && !(a10 instanceof Error) && !(a10 instanceof Date) && !(globalThis.Blob && a10 instanceof globalThis.Blob), dO = Symbol("mapObjectSkip"), dP = (a10, b10, c10, d10 = /* @__PURE__ */ new WeakMap()) => {
        ...
        return { status: e2.SignedIn, reason: null, message: null, proxyUrl: b10.proxyUrl || "", publishableKey: b10.publishableKey || "", isSatellite: b10.isSatellite || false, domain: b10.domain || "", signInUrl: b10.signInUrl || "", signUpUrl: b10.signUpUrl || "", afterSignInUrl: b10.afterSignInUrl || "", afterSignUpUrl: b10.afterSignUpUrl || "", isSignedIn: true, isAuthenticated: true, tokenType: a10.tokenType, toAuth: ({ treatPendingAsSignedOut: c11 = true } = {}) => {
          if (a10.tokenType === cn.SessionToken) {
            let { sessionClaims: e11 } = a10, f11 = function(a11, b11, c12) {
              let d11, { actor: e12, sessionId: f12, sessionStatus: g11, userId: h2, orgId: i2, orgRole: j2, orgSlug: k2, orgPermissions: l2, factorVerificationAge: m2 } = ((a12) => {
                ...
                if (2 === a12.v) {
                  if (a12.o) {
                    ...
                    let { org: f14 } = cb(a12.fea), { permissions: g13, featurePermissionMap: h3 } = (({ per: a13, fpm: b13 }) => {
              ...
              return { tokenType: cn.SessionToken, actor: e12, sessionClaims: c12, sessionId: f12, sessionStatus: g11, userId: h2, orgId: i2, orgRole: j2, orgSlug: k2, orgPermissions: l2, factorVerificationAge: m2, getToken: o2, has: (d11 = { orgId: i2, orgRole: j2, orgPermissions: l2, userId: h2, factorVerificationAge: m2, features: c12.fea || "", plans: c12.pla || "" }, (a12) => {
      ...
      var e6 = (a10) => {
        ...
        deriveUrlFromHeaders(a10) {
          let b10 = new URL(a10.url), c10 = a10.headers.get(ci.Headers.ForwardedProto), d10 = a10.headers.get(ci.Headers.ForwardedHost), e10 = a10.headers.get(ci.Headers.Host), f10 = b10.protocol, g10 = this.getFirstValueFromHeader(d10) ?? e10, h2 = this.getFirstValueFromHeader(c10) ?? f10?.replace(/[:/]/, ""), i2 = g10 && h2 ? `${h2}://${g10}` : b10.origin;
          ...
          try {
            return function(a11, b10) {
              try {
                ...
                return c10 = void 0, d10 = [], e10 = a7(a11, d10, c10), f10 = d10, g10 = c10, void 0 === g10 && (g10 = {}), h2 = g10.decode, i2 = void 0 === h2 ? function(a12) {
                  return a12;
                } : h2, function(a12) {
...
${a12.message}`);
      ...
      var fq = async (a10, b10) => {
        ...
        let g10 = new fn(b10.organizationSyncOptions), h2 = new fm(c10, { organizationSyncOptions: b10.organizationSyncOptions }, g10);
        ...
        function k2(a11, b11, c11, d11) {
          if (!h2.isRequestEligibleForHandshake()) return e5({ tokenType: cn.SessionToken, authenticateContext: a11, reason: b11, message: c11 });
          let e11 = d11 ?? h2.buildRedirectToHandshake(b11);
          return (e11.get(ci.Headers.Location) && e11.set(ci.Headers.CacheControl, "no-store"), h2.checkAndTrackRedirectLoop(e11)) ? (console.log("Clerk: Refreshing the session token resulted in an infinite redirect loop. This usually means that your Clerk instance keys do not match - make sure to copy the correct publishable and secret keys from the Clerk dashboard."), e5({ tokenType: cn.SessionToken, authenticateContext: a11, reason: b11, message: c11 })) : function(a12, b12, c12 = "", d12) {
      ...
      var fu = c(66);
      let fv = "" + fu.s8 + ";404";
      fu.s8, fu.s8, c(515).X, c(449), "undefined" == typeof URLPattern || URLPattern, c(107), c(979), c(770), c(823), c(918);
      ...
      let fQ = process.env.CLERK_API_VERSION || "v1", fR = process.env.CLERK_SECRET_KEY || "", fS = process.env.CLERK_MACHINE_SECRET_KEY || "", fT = "pk_test_Zml0dGluZy1wZW5ndWluLTcwLmNsZXJrLmFjY291bnRzLmRldiQ", fU = process.env.CLERK_ENCRYPTION_KEY || "", fV = process.env.CLERK_API_URL || ((a10) => {
...
Original error: ${a10}`);
      ...
      let gb = { secretKey: fR, publishableKey: fT, apiUrl: fV, apiVersion: fQ, userAgent: "@clerk/nextjs@6.39.2", proxyUrl: fX, domain: fW, isSatellite: fY, machineSecretKey: fS, sdkMetadata: { name: "@clerk/nextjs", version: "6.39.2", environment: "production" }, telemetry: { disabled: f$, debug: f_ } }, gc = (a10) => function(a11) {
...
For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`, hl = bA({ packageName: "@clerk/nextjs" }), hm = "x-middleware-override-headers", hn = "x-middleware-request", ho = (a10, b10, c10) => {
      ...
      }, hp = (a10) => R.redirect(a10, { headers: { [ci.Headers.ClerkRedirectTo]: "true" } }), hq = "clerk_keyless_dummy_key";
      function hr() {
      ...
      let hJ = (a10) => !!a10.headers.get(fH.Headers.NextUrl) && !((a11) => {
        var b10, c10;
        ...
        return !!(c10 || b10);
      }, hL = (a10) => !!a10.headers.get(fH.Headers.NextjsData), hM = ((a10) => {
        ...
        return gg.run(gf, () => {
          let a11 = /* @__PURE__ */ ((a12, b11) => (...c11) => {
            let d11 = ("string" == typeof a12 ? /* @__PURE__ */ ((a13, b12) => () => {
              ...
              return { enable: () => {
                ...
                if (d12) {
                  ...
                  console.log((f11 = a13, `[clerk debug end: ${f11}] (@clerk/nextjs=6.39.2,next=${fK.version},timestamp=${Math.round((/* @__PURE__ */ new Date()).getTime() / 1e3)})`));
                }
              } };
            ...
            let h2, i2, j2, k2, l2, m2, n2, o2, p2 = "function" == typeof e10 ? await e10(b11) : e10, q2 = await hy((a13) => {
              ...
              return a13 || b12(), a13;
            }(p2.publishableKey || fT || (null == q2 ? void 0 : q2.publishableKey), () => hl.throwMissingPublishableKeyError()), s2 = function(a13, b12) {
              return a13 || b12(), a13;
            }(p2.secretKey || fR || (null == q2 ? void 0 : q2.secretKey), () => hl.throwMissingSecretKeyError()), t2 = { publishableKey: r2, secretKey: s2, signInUrl: p2.signInUrl || fZ, signUpUrl: p2.signUpUrl || "/sign-up", ...p2 };
            ...
            let y2 = await u2.authenticateRequest(v2, ((a13, b12) => ({ ...b12, ...((a14, b13) => {
              ...
              if (e11 && !gj(g12) && bn(b13.secretKey || fR)) throw Error(hj);
            ...
            let B2 = (h2 = v2, (a13 = {}) => {
              ...
              return async (...a15) => {
                ...
                })(a15[0]), q3 = (null == (h3 = a15[0]) ? void 0 : h3.unauthenticatedUrl) || (null == (i3 = a15[1]) ? void 0 : i3.unauthenticatedUrl), r3 = (null == (j3 = a15[0]) ? void 0 : j3.unauthorizedUrl) || (null == (k3 = a15[1]) ? void 0 : k3.unauthorizedUrl), s3 = (null == (l3 = a15[0]) ? void 0 : l3.token) || (null == (m3 = a15[1]) ? void 0 : m3.token) || cn.SessionToken, t3 = () => c12.tokenType === cn.SessionToken && db(cn.SessionToken, s3) ? r3 ? d11(r3) : e11() : g12();
                ...
                if ("pending" === c12.sessionStatus || !c12.userId) {
                  return q3 ? d11(q3) : "document" === (n3 = f12).headers.get(ci.Headers.SecFetchDest) || "iframe" === n3.headers.get(ci.Headers.SecFetchDest) || (null == (o3 = n3.headers.get(ci.Headers.Accept)) ? void 0 : o3.includes("text/html")) || hJ(n3) || hL(n3) ? b13() : e11();
                }
            ...
            }(), unauthorized: hI, authObject: e1({ authObject: k2, acceptsToken: (null == a13 ? void 0 : a13.token) || (null == b12 ? void 0 : b12.token) || cn.SessionToken }), redirectToSignIn: l2 })(a13, b12)), E2 = (m2 = y2, n2 = B2, o2 = C2, async (a13) => {
              var b12;
            ...
            try {
              ...
              F2 = ((a14, b12, c12, d11) => {
                ...
                if (f12 || g12) {
                  let c13 = ((a15) => {
                    let { publishableKey: b13, redirectAdapter: c14, signInUrl: d12, signUpUrl: e12, baseUrl: f13, sessionStatus: g14 } = a15, h3 = bl(b13), i3 = h3?.frontendApi, j3 = h3?.instanceType === "development", k3 = b5(i3), l3 = "pending" === g14, m3 = (b14, { returnBackUrl: d13 }) => c14(cj(f13, `${b14}/tasks`, d13, j3 ? a15.devBrowserToken : null));
                    return { redirectToSignUp: ({ returnBackUrl: b14 } = {}) => {
                      ...
                      return l3 ? m3(h4, { returnBackUrl: b14 }) : c14(cj(f13, h4, b14, j3 ? a15.devBrowserToken : null));
            ...
            t2.debug && ho(F2, v2, { [ci.Headers.EnableDebug]: "true" });
            ...
            return !function(a13, b12, c12, d11, e11, f12) {
              ...
              if (g12) {
                let c13 = function(a14, b13, c14) {
                  ...
                  let f13 = a9() ? fU || (d12 = () => hl.throwMissingSecretKeyError(), fR || d12(), fR) : fU || fR || hq;
                  return he.encrypt(JSON.stringify({ ...b13, ...a14, machineAuthObject: null != c14 ? c14 : void 0 }), f13).toString();
                }(d11, e11, f12);
                ho(b12, a13, { [ci.Headers.AuthStatus]: j3, [ci.Headers.AuthToken]: k3 || "", [ci.Headers.AuthSignature]: k3 ? hh(k3, (null == d11 ? void 0 : d11.secretKey) || fR || e11.secretKey || "").toString() : "", [ci.Headers.AuthMessage]: i3 || "", [ci.Headers.AuthReason]: h3 || "", [ci.Headers.ClerkUrl]: a13.clerkUrl.toString(), ...c13 ? { [ci.Headers.ClerkRequestData]: c13 } : {} }), b12.headers.set(fH.Headers.NextRewrite, g12.href);
              }
            ...
            }), i2 = !(g11.publishableKey || fT || (null == h2 ? void 0 : h2.publishableKey)), j2 = null != (f11 = null == (d11 = gd(b11, ci.Headers.Authorization)) ? void 0 : d11.replace("Bearer ", "")) ? f11 : "";
            if (i2 && !c8(j2)) {
              let a12 = R.next();
              return ho(a12, b11, { [ci.Headers.AuthStatus]: "signed-out" }), a12;
            }
            return a11(b11, c11);
...
var PrerenderManifest = { "version": 4, "routes": { "/opengraph-image": { "initialHeaders": { "cache-control": "public, immutable, no-transform, max-age=31536000", "content-type": "image/png", "x-next-cache-tags": "_N_T_/layout,_N_T_/opengraph-image/layout,_N_T_/opengraph-image/route,_N_T_/opengraph-image" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/opengraph-image", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/sitemap.xml": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "application/xml", "x-next-cache-tags": "_N_T_/layout,_N_T_/sitemap.xml/layout,_N_T_/sitemap.xml/route,_N_T_/sitemap.xml" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/sitemap.xml", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "6dfd46ff74a7e346696c9dee11675f0e", "previewModeSigningKey": "8677935905194b17681a3d5ed86d187b909a7ffa4480fa42c93557f1f42bf97e", "previewModeEncryptionKey": "600b32e3b5a6456199bc63d7ebcdd4143eff4d666d9631349378f0f633ff302d" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "0isFnxwrNcX2R6pkltNcK", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "GvXbTTUIJemcrHOM7mFprCcKzg1eZQbR0FlOtjcpfiE=", "__NEXT_PREVIEW_MODE_ID": "6dfd46ff74a7e346696c9dee11675f0e", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "8677935905194b17681a3d5ed86d187b909a7ffa4480fa42c93557f1f42bf97e", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "600b32e3b5a6456199bc63d7ebcdd4143eff4d666d9631349378f0f633ff302d" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/stripe/checkout/route": "/api/stripe/checkout", "/api/alerts/[id]/route": "/api/alerts/[id]", "/api/stripe/webhook/route": "/api/stripe/webhook", "/api/alerts/route": "/api/alerts", "/api/v1/figure/[figure_id]/route": "/api/v1/figure/[figure_id]", "/api/user-settings/route": "/api/user-settings", "/api/v1/search/route": "/api/v1/search", "/api/vault/[id]/route": "/api/vault/[id]", "/api/vault/route": "/api/vault", "/api/wantlist/[id]/route": "/api/wantlist/[id]", "/api/wantlist/route": "/api/wantlist", "/sitemap.xml/route": "/sitemap.xml", "/opengraph-image/route": "/opengraph-image", "/[genre]/page": "/[genre]", "/page": "/", "/[genre]/[line]/[slug]/page": "/[genre]/[line]/[slug]", "/sign-up/[[...sign-up]]/page": "/sign-up/[[...sign-up]]", "/terms/page": "/terms", "/sign-in/[[...sign-in]]/page": "/sign-in/[[...sign-in]]", "/privacy/page": "/privacy", "/figure/[figure_id]/page": "/figure/[figure_id]", "/pro/page": "/pro", "/app/alerts/page": "/app/alerts", "/app/settings/page": "/app/settings", "/app/vault/page": "/app/vault", "/app/wantlist/page": "/app/wantlist", "/app/page": "/app" };
