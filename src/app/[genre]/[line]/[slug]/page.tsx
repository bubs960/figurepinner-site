...
import { fitFigureTitle, fitFigureTitleWithPrice } from '@/lib/fitTitle'
import { priceInTitleEnabled, titlePriceFragment } from '@/lib/titlePriceTest'
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    // Price-in-title test: one fandom, trustworthy-tier prices only (titlePriceTest.ts).
    title: priceInTitleEnabled(figure.fandom)
      ? fitFigureTitleWithPrice(figurePageTitle(displayName, lineName, deriveEmbeddedLine(figure)), titlePriceFragment(contract))
      : fitFigureTitle(figurePageTitle(displayName, lineName, deriveEmbeddedLine(figure))),
