...
,
  ...
  {
    slug: 'sdcc-2026-toy-reveal-roundup',
    title: 'SDCC 2026: Every Reveal Worth Tracking, and Why Half of Them You\'ll Never Own',
    metaTitle: 'SDCC 2026 Toy Reveals — Wrestling, Star Wars, Marvel Legends & More | FigurePinner',
    metaDescription: 'Every confirmed SDCC 2026 figure reveal across wrestling, Star Wars, Marvel Legends, G.I. Joe, TMNT, DC, MOTU, and Mythic Legions: booth numbers, prices, and why most of it never reaches retail.',
    dek: 'Danhausen has a panel. Todd McFarlane has three new Green Lanterns and a Red Hood. Here is what is actually confirmed this week, and what is just booth-exclusive bait.',
    readingMinutes: 7,
    updated: '2026-07-23',
    body: [
      ...
      { type: 'p', text: 'Mattel had not shown a single new WWE figure ahead of Preview Night -- see below for what changed Wednesday evening. What has been official since before the show is the panel structure, and it tells you something on its own: the WWE Elite Squad Reveal Panel is Thursday, July 23, 11:15am to 12:15pm, Room 6A, with Danhausen, Rey Mysterio, and Sam Roberts on stage plus unnamed "surprise appearances." A meet-and-greet follows at 1:15pm at the Mattel booth (#2945), where SDCC collector posters and pins go out to whoever is standing there. Elite exclusives have gone from "figure nobody wanted" to "figure everybody scalps" inside a single generation, and the fact that Mattel is booking a comedian-wrestler and a Hall of Famer to do the reveal instead of just posting a product shot tells you they know it too. Mattel is also skipping the line entirely for anyone not in San Diego: all eight of the booth\'s SDCC collectibles, WWE included, go up for sale on MattelCreations.com at 9am PT Thursday, ahead of the panel itself.' },
      { type: 'p', text: 'Mattel is not waiting for the panel to sell something, though. Preview Night already put a WWE Rock \'n Wrestling Connection 3-Pack on the floor at the Mattel booth: Roddy Piper, Cyndi Lauper, and Captain Lou Albano for $80, boxed to look like a vintage 1980s TV set. It is a nod to an angle most current fans only know from documentary clips, priced like Mattel knows exactly who is buying it.' },
      { type: 'p', text: 'Jakks Pacific has said nothing about an AEW exclusive for this show -- and having gone back to check, that is probably because Jakks is not the one carrying AEW at this con. Jazwares is: a Will Ospreay figure, $60, at their booth (#3513). If you came looking for Jakks-branded AEW, you are looking at the wrong company\'s table this year.' },
      { type: 'p', text: 'Preview Night itself already showed more than the box on the shelf. Booth reports from the floor Wednesday night put an Ultimate Edition Penta on display -- his only prior 2026 Mattel news was a Defining Moments debut and a Main Event Series 163 release, so an Ultimate tier would be a real step up, not a re-release. A Dominik Mysterio figure was also on the table (Mattel already runs a \"Dirty\" Dominik Ultimate Edition, so whether this is that figure or something new is still unclear without a photo). And the one that actually got people talking: a Sheamus figure with a color-change gimmick, chest paint that turns red when wet, which is not a feature we have seen on a WWE figure before. None of this is official yet -- no Mattel press photo, no SKU, no Creations listing -- so treat it as a strong first-hand report from the floor, not a confirmed reveal, until it shows up in writing somewhere we can point to. We will update this the moment it does.' },
      { type: 'h2', text: 'Star Wars and Marvel Legends: Hasbro plays it safe' },
      { type: 'p', text: 'Hasbro\'s Black Series exclusive is an ARF Trooper (501st) and AT-RT set; the Vintage Collection gets an Anakin Skywalker and Asajj Ventress two-pack. Neither is a deep cut. TVC diehards who track VC numbers from memory are not going to riot over either, and that is probably the point: con exclusives sell out on scarcity, not on being someone\'s grail.' },
      { type: 'p', text: 'Marvel Legends gets more to talk about. The X-Men \'97 Professor Xavier comes with the yellow hoverchair, swappable blaster attachments, a translucent psychic-effect piece, and both the Cerebro helmet and an alternate head. That is a real deluxe-tier accessory count, not a re-carded single. The Spider-Man "Meme-tastic" three-pack (Spider-Man in the pointing pose, Curt Connors as Lizard, Electro) is a straight cash-in on the 1967 cartoon\'s second life as internet furniture, and it will sell exactly as well as you think a meme in plastic sells to people who grew up quoting it unironically.' },
      { type: 'h2', text: 'G.I. Joe, and the crossover nobody asked for that we kind of want anyway' },
      { type: 'p', text: 'Hasbro\'s two Classified exclusives lean into deep-cut episode references rather than filecard royalty: a Fatal Fluffies set built around "Pyramid of Darkness" in retro cereal-box packaging, and a Shipwreck vs. Cadet Deming set pulled from "There\'s No Place Like Springfield." Neither is the Snake Eyes re-release the line keeps threatening to retire; both are collector-brain deep pulls that reward people who actually watched the cartoon past the toy commercials.' },
      { type: 'p', text: 'The actual crossover money is sitting in Playmates\' booth instead: a TMNT x G.I. Joe Snake Eyes x Leonardo figure set for $39.99, sold through UCC Distributing (booth #5613), alongside an exclusive Timber x Rahzar figure. Two completely separate licensors agreeing to a crossover at a convention booth, rather than through either company\'s own mainline, is the kind of thing that only happens because someone in a boardroom noticed both fandoms overlap more than anyone admits.' },
      { type: 'h2', text: 'DC Multiverse: McFarlane brought a whole Lantern Corps' },
      { type: 'p', text: 'Todd McFarlane\'s booth (#1915) is running four Gold Label exclusives on its own: Red Hood (Under the Red Hood) as Collector Edition #65, Kilowog as #64, John Stewart in Ultraviolet Lantern deco, and Kyle Rayner in White Lantern deco. A fourth Lantern, Hal Jordan, is sold separately through UCC Distributing\'s booth instead of McFarlane\'s own. Worth knowing before you walk to the wrong line. Three ring colors from one booth in one show is McFarlane leaning hard into the one gimmick DC Multiverse always has in its back pocket: however deep you think the Green Lantern corps roster goes, there is another Lantern color to reissue it in.' },
      { type: 'h2', text: 'TMNT: three companies, three different turtles' },
      { type: 'p', text: 'This is the clearest example this show of a license split three ways by scale and continuity, same as it always is. Playmates has the Platinum Shell Collection, a blind-box line at $29.99 each: Leo, Don, Mike, and Raph, each hiding in green, silver, or gold metallic finish, twelve possible pulls total. NECA (booth #3545) countered with a 2012 Cartoon Sketch four-pack in Ciro Nieli\'s black-and-white style, accessorized down to pizza slices and Ice Cream Kitty. Super7 is doing a glow-in-the-dark ReAction+ four-pack for the vintage-toy crowd. Nobody is fighting over the same turtle twice; that is the entire TMNT business model working exactly as designed.' },
      { type: 'h2', text: 'Transformers: Hasbro found the nostalgia in two different directions at once' },
      { type: 'p', text: 'Hasbro\'s Transformers booth exclusives split between two different eras of the same fandom\'s memory. The first is an Optimus Prime & Autobot Jazz Cereal Box Set: a 5.5-inch Optimus that converts robot-to-truck in 14 steps (its trailer folds out into a combat deck and repair bay) and a 3.5-inch Jazz that converts robot-to-sports-car in 8, both packaged like an \'80s cereal box. The second is a Transformers x Jem and the Holograms crossover set: a 7-inch Autobot Blaster in Jem-inspired deco that converts bot-to-boombox in 20 steps, plus three mini-cassette figures. Two completely different childhoods being sold at the same booth. Hasbro Pulse is running its own Transformers collectibles panel Sunday, July 26, 1:45 to 2:45pm, for anyone still in town after the rest of the show has emptied out.' },
      { type: 'h2', text: 'MOTU, and a correction we made mid-research' },
      { type: 'p', text: 'We went looking for a Super7 MOTU exclusive this year and did not find one confirmed. What we found instead: Mattel Creations has a "Gym Bro Skeletor," and Mondo (not Super7) is the one selling SDCC-exclusive Panthor and Keldor figures. Worth saying plainly, because getting the company wrong on a con exclusive is exactly the kind of mistake that gets a collector site laughed out of the comments section.' },
      { type: 'h2', text: 'Mythic Legions and the indie booths actually worth the walk' },
      { type: 'p', text: 'Four Horsemen Studios is sharing booth #4344 with Icon Heroes, and their lineup is the most accessory-dense thing at the whole show: Cosmic Legions\' Saint Demmyan comes with three heads, two helmet attachments, two hand sets, a back adapter, backpack, removable dome armor, and a fully wired, poseable soft-goods cape. Ringmassster, a Four Horsemen x Icon Heroes collab, ships with a spear, two scrolls, four hand sets, a bendy tail, two heads, and a removable reptilian-body gi. The yearly "touring figure," Legendary Warrior, and a limited Cursed Templar (also headed to LegionsCon and online later this year, so this one is not actually a one-shot) round it out. If you only have time for one indie booth this week, this is the one where the sculpt-and-articulation-per-dollar math actually favors you.' },
      { type: 'callout', text: 'Smaller makers worth watching: Jada Toys already put its lineup on the floor Preview Night, and it is the rare case here of pricing you can actually check against right now -- a Battle Damaged Invincible 1:12 figure at $40, an Ultra Street Fighter II Akuma (Player 2 Deluxe) figure at $45, and a "You Lose" accessory set with swappable head sculpts for all 19 Street Fighter II characters at $50, all live online now via Jada Next Level. Nacelle Toys has a 50-unit Biker Mice From Mars variant; Handmade by Robots has a 1,000-piece Kuchi Kopi at $19.99; Super7 is using this show for its first reveal under a brand-new license, an Invincible Universe Battle Beast Ultimates figure. On the DC side, Beast Kingdom (a separate line from McFarlane\'s DC Multiverse above) already sold through most of its Dynamic 8ction Heroes SDCC run -- Lobo, Batman, Superman, Reverse Flash, and Darkseid variants between $50 and $99 -- before preorders even closed.' },
      { type: 'h2', text: 'What we are actually watching' },
      { type: 'p', text: 'The wrestling panel Thursday is the one that matters most for anyone reading this site. It is the only major reveal on this list that has not happened yet, and Mattel booking Danhausen for the stage instead of just dropping a press release says they expect it to travel. We track over 6,000 wrestling figures and 4,000 Star Wars figures already, so once real SKUs exist, real eBay sold data follows within days, not months. This piece gets updated the moment the panel wraps.' },
      { type: 'p', text: 'Everything else on this list is booth-exclusive, capped, and going to resell before most of you get home from the show. Buy what you actually want to own, not what looks smart to flip. The flip market on con exclusives is already crowded with people who had the same idea you just had.' },
    ],
  },
]
