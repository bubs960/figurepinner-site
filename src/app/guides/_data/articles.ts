...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    dek: 'Two runs, one card design. The 2010-12 cards price 65 percent above the 2018 relaunch, and nothing in our sold data says why.',
    readingMinutes: 7,
    updated: '2026-09-12',
    shortVersion:
      'A 2018-on carded single trades at $19.99; a 2010-12 card trades at $33, a 65 percent gap on the same scale and card design. The real money sits in HasLab boxes, 2010 foil-card variants, and deep-cut figures with just one card in the catalog. Check the exact VC number before you pay:',
    body: [
      ...
      { type: 'p', text: 'Two Imperial TIE Fighter releases sit eight years apart at $80 (2010, Target) and $89.99 (2018, Walmart), proof at least one vehicle here has come back for a second run, against a category that mostly reads one-and-done. The N-1 Starfighter (2023) outprices both TIEs at $95 across 50, against $131.99 retail. The 2026 Imperial Remnant AT-RT sits lower, $64.84 against $67.99 retail. Neither reaches its own shelf price, and the N-1’s $131.99 is the bigger miss.' },
      { type: 'h2', text: '2010’s foil cards, and where the premium stops' },
      { type: 'p', text: 'The 2010 wave shipped foil-card variants of several figures. Clone Commander Cody Foil holds $110 across 50 against $50 across 15 for the standard card; Boba Fett (ESB) Foil is $65.99 across 50. Darth Vader (Anakin Skywalker) Foil and the standard card both land at $50 across 50 here, though the foil also carries a second, conflicting id at $59.99, the same duplicate-entry problem as the Ghost. General Grievous reverses it entirely: the foil card is $79.99 across 50, the standard card $109.99 across 50. Plain outprices foil by $30, and nothing here explains why.' },
      ...
      { type: 'p', text: 'Of 678 releases, 672 have a comp and 642 clear the five-sale bar, but the catalog still has problems. Six records carry no release year, Krrsantan and a Hasbro Pulse Imperial Remnant Stormtrooper four-pack among them. VC numbers sit only in each release’s free-text notes, not a field you can filter on, so citing "VC98" means trusting the catalog’s own copy. And the Galaxy’s Edge Millennium Falcon: Smuggler’s Run is filed twice, once under a correctly spelled name with no sales data, once under a garbled one carrying a real $849.99 median across 37 sold, top $1,936. The good data exists, filed where nobody would look for it.' },
      { type: 'p', text: 'The 2018-on singles trade close to their $16.99 shelf price. The 2010-12 run is the one worth studying release by release, since it spans Bom Vimdin’s $11.50 and Jocasta Nu’s $199.99 on the same Kenner-homage card. Vehicles are where the money holds: of the 39 names in that lineup, only four (AT-AT, Imperial TIE Fighter, Slave I, and X-Wing) show a second release in our catalog. The floor is $10 figures wearing famous names.' },
      { type: 'h2', text: 'Further reading' },
      { type: 'ul', items: [
  ...
  },
  {
    ...
    // length).
    // Voice pass 2026-09-24 (PR #37, the five held guides): body prose is now
    // 1,144 words with 0 em-dashes; process language and QA jargon rewritten
    // in plain words, and the closing paragraph no longer claims the sub-$100
    // rows are filtered out of the quoted numbers (nine of the ten sit inside
    // the 274-release median, $298.99; it reads $299.99 without them).
    ...
    dek: 'Most Hot Toys Star Wars figures resell for about what they cost. The real premiums sit in one-release troopers, a short list of vehicle sets, and the two heroes who out-earn every Vader on the shelf.',
    readingMinutes: 7,
    updated: '2026-09-12',
    shortVersion:
      'A standard Hot Toys Star Wars figure trades near its roughly $300 retail; the real gains sit in one-release troopers and a handful of vehicle sets, while several sets, Sandtrooper Sergeant & Dewback among them, now sell under their own box price. Check the release before paying a premium:',
    body: [
      { type: 'p', text: 'Strip out the one Sideshow-made piece mislabeled into this catalog, an Obi-Wan Kenobi tagged Mythos, and 274 releases are left with a real eBay comp and enough sales to trust. The median across those 274 (the median of release medians, not of every sale) is $298.99, and 152 of them, $250 to $400 inclusive on both ends, sit inside that retail band. Fifty-five percent of this line resells for roughly what it cost.' },
      { type: 'p', text: 'That 274-release set is the strict end of a much bigger catalog: FigurePinner carries 358 Hot Toys Star Wars releases in this line, and real eBay sold data turns up for only 305 of them. Of those 305, 275 clear the five-sale floor we treat as reliable, and 274 once the Mythos release is pulled out. Thirty-one releases price above $400, and eleven clear $600; nothing in the sample reaches $1,000. It is mostly not heroes doing the clearing.' },
      { type: 'h2', text: 'Tarkin’s the record, Death Star Gunner’s the return' },
      { type: 'p', text: 'Grand Moff Tarkin (2017) leads on dollars: $795 across 41 sold, the highest single-figure median in the catalog. The next-closest solo release, Crosshair, is $45 back at $749.99, and Death Star Gunner trails by $95 at $699.99. The catalog holds no second solo Tarkin. The only other Tarkin entry is a Grand Moff Tarkin and Darth Vader two-figure box from the same year, which sells higher at $850 across 31 sold but, as a set, doesn’t count toward the single-figure record. Measure against what each figure cost at retail, though, and Tarkin is not even first: across every release in our catalog with a five-sale sample and a listed retail price, Death Star Gunner’s $699.99 median is 3.41 times its $204.99 retail, the highest ratio there is, just ahead of Tarkin’s 3.38x. Our data shows the gap, not the reason a plain helmet and chest box out-earns a named Imperial officer.' },
      ...
      { type: 'h2', text: 'Sixteen Vaders, twelve of them one number' },
      { type: 'p', text: 'Darth Vader has 16 releases in this catalog with comps. Twelve of them, from the standard ESB figure to the ESB 40th Anniversary release, show identical sold data: $335.80 median across 20 sold, $599.99 top. That is one pool of eBay sales shared by all twelve, not twelve prices; treat $335.80 as the number for a Deluxe or Special Edition Vader. The other four: Rogue One lands at that same $335.80 median across 21 sold, near the pool but not identical. Deluxe Battle Damaged holds $310 across 50. A plain 2022 listing has one sale, too thin to use. The one that matters is the 2025 Battle Damaged: $350 across 47 sold, the best-performing Vader in the catalog and still inside the retail band.' },
      ...
      { type: 'p', text: 'Ten of the 305 comped releases in this catalog return medians under $100 on a line that otherwise centers around $300: a $9 Cassian Andor, a $24.50 Stormtrooper Set, a $26.99 Boushh Leia, a $38.84 Leia (Last Jedi), a $44.99 501st Battalion Clone Trooper, a $50 Wicket, and four more. Price alone can’t say what those sales were, whether smaller-scale figures, loose parts or accessories matched to the wrong entry, and we haven’t reviewed the listings. Treat a sub-$100 Hot Toys sale as suspect until the photos show a complete sixth-scale figure.' },
      { type: 'p', text: 'A Vader, Luke, or Obi-Wan buy is a bet on the sculpt in front of you. Sandtrooper Sergeant & Dewback sits at half its $704.99 retail, and the next buyer at $365 gets the good end of that trade.' },
      { type: 'h2', text: 'Further reading' },
      { type: 'ul', items: [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: 'Our catalog holds 318 records for the line, but 52 names are duplicated and collapse to one release apiece once you net them out, which puts the real release count at 266. Four years in, 54 of those 318 records carry a sold comp at all and 19 clear five sales. Most of this line still has no median.' },
      { type: 'h2', text: 'Nine classes, and Slave I isn’t a Starfighter' },
      { type: 'ul', items: [
        'Scout Class, 90 records (75 distinct), $5.99 retail: speeder bikes, STAPs, AT-RTs, escape pods, each with a removable figure. The army-builder floor.',
        'Light Armor Class, 64 records (50 distinct), the retail figure most rows carry is $12.99: TIE Fighters, A-Wings, Jedi starfighters, the AT-ST. Ten of the 50 carry an explicit chase, rare, or scarcer-variant label in our catalog copy. That is a lot of chasing at this price.',
        'Starfighter Class, 73 records (56 distinct), the retail figure most rows carry runs $14.97 to $16.99 (one outlier, the New Republic X-Wing at $56.01): X-Wings, TIE Advanced, snowspeeders.',
        'Starship Class, 21 records (18 distinct), the retail figure most rows carry is $29.99 to $34.99 (one outlier, the ARC-170 Starfighter at $8.89): shuttles, the Tydirium, and both Boba Fett’s Starship (Slave I) and the Razor Crest, which sit here and not with the Starfighters.',
        'Assault, Dreadnaught, and Transport, 12 records combined (11 distinct: 6 Assault, 3 Dreadnaught, 2 Transport): the AT-AT, the Millennium Falcon, TIE Reaper, Ghost, and the Imperial Troop Transport. Only four of the twelve carry a clean retail figure: Ghost $59.99, TIE Reaper $39.83, Ahsoka Tano’s T-6 Shuttle $29.97, Imperial Troop Transport $22.99. That makes $22.99 to $59.99 the floor for this tier.',
        'Exclusives, 41 records (39 distinct), $12.62 to $135. Target and Amazon drops sit alongside an SDCC exclusive, and the Vault line adds 17 multi-figure box sets at $60, $80, or $100 depending on class, plus a standalone Vault-edition Millennium Falcon, one of the two that share $17 across 10 below.',
      ...
      { type: 'p', text: 'That ladder is the first thing to check on a listing. A $30 Light Armor TIE Fighter is usually a chase or a mislabel; a $30 Starship shuttle is retail. Some of the confusion in the sold listings is a seller pricing by ship name when Jazwares prices by class and rarity.' },
      { type: 'h2', text: 'Chases, rares, and the Armada repaints' },
      { type: 'p', text: 'Our catalog copy carries the rarity system: the Hera Syndulla A-Wing is a Series 2 Rare variant, Luke’s Landspeeder a Series 4 Chase, Kit Fisto’s Jedi Starfighter a Series 5 Chase, and Saesee Tiin’s Jedi Starfighter the scarcer of two releases sharing that name, one a standard-retail ship, one explicitly labeled scarcer in our copy. Armada Edition sits next to this as a separate deco program: 13 named vehicles across Light Armor and Starfighter classes, from the grey TIE Fighter and TIE Interceptor decos to X-Wings, an AT-ST, a Vulture Droid, and gauntlet and interceptor fighters for Bo-Katan and Obi-Wan. Nothing in our catalog ties a print number to a specific figure, so a ships-one-per-case claim you see elsewhere is somebody’s guess, not ours.' },
      { type: 'h2', text: 'What actually has a number' },
      { type: 'p', text: 'Nineteen of 318 records clear five sold matches, but nine of those nineteen are duplicates in disguise. Five TIE Fighter decos (Battle Damage, Sabine Wren, Translucent Blue, the grey Armada Edition, and Twilight Squadron) share one $19.99-across-9 signal. Two X-Wings, the Kenner-deco Luke and the Hera Syndulla release, share $100 across 8. Two Millennium Falcons, A New Hope and the Vault edition, share $17 across 10. Those are category signals, not per-release prices. That leaves ten releases with a distinct sold history, and their median of medians is $25.97: call that the typical release once you are past Scout Class pocket change. Pool all nineteen instead, duplicates included, and the number drops to $19.99, mostly the TIE Fighter signal pulling it down.' },
      ...
      { type: 'p', text: 'First, 52 names in our catalog are logged twice. Thirty-nine of those pairs are two blank rows with no sold data on either side. Twelve pairs are one blank row and one with a real comp. The last one, Saesee Tiin’s Jedi Starfighter, carries different sold data on both sides: a scarcer-labeled variant at $19.99 across 14 and a standard-retail version at $14 on a single sale. Net each of the 52 down to one release and Micro Galaxy Squadron is 266 distinct releases, not 318, and every class count above already reflects it. Second, four retail prices in our catalog are broken: AT-AT Walker at $2.68, AT-TE at $1.51, Gungan Bongo Submarine at $1.25, and the AvA Speeder Bike (Ezra Bridger) at $1.82. Nobody paid those numbers at any Target in any year. Do not trust the retail figure on those four rows until somebody fixes it.' },
      { type: 'p', text: 'TIE Reaper is the correct read on this line right now: a real 28-sale sample at $19 against a $39.83 tag, the deepest sample in the whole catalog, now selling for under half its retail. That is the buy. The AT-AT at $45 across 11 is priced fairly, not cheap, and Black Squadron’s $77.99 against a $70 list is the one exclusive holding a real premium on seven sales. Everything under Light Armor’s $12.99 floor is army-builder inventory. With 266 real releases and only 19 defensible medians, price your figure against the ten non-pooled numbers above, not the five that are the same TIE Fighter wearing a different sticker.' },
      { type: 'h2', text: 'Further reading' },
      { type: 'ul', items: [
        '[[Star Wars Vintage Collection price guide|/guides/star-wars-vintage-collection-price-guide]]: the 3.75-inch cardback line',
        ...
        '[[Pricing thin-comp figures|/guides/pricing-thin-comp-figures]]: what to do when a figure has two sales or none, which is most of this line',
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    dek: 'The line that put Star Wars back on pegs in 1995 still prices out in sold comps at eleven to sixteen dollars a figure, and a lot more for the boxed vehicles and playsets.',
    readingMinutes: 6,
    updated: '2026-09-12',
    shortVersion:
      'A 1995–2000 Power of the Force carded figure runs $11 to $16 depending on card color, with one carded single over $50, at $75; the real money sits in vehicles, a $27 median that runs up to $100. Check the exact release before paying a red-card premium for anyone but R2-D2:',
    body: [
      { type: 'p', text: 'Kenner relaunched Star Wars figures in 1995 after a decade off the pegs, on a red card, with sculpts built like the whole cast had spent the interim in a gym. The buff-Luke joke is as old as the line, and it still lands. The line ran red card into green, then split across Freeze Frame and Flashback cards, with CommTech chip releases alongside, plus Shadows of the Empire and Expanded Universe sub-lines and a run of vehicles beside them.' },
      { type: 'p', text: 'Sold data backs the great majority of this catalog: 215 of 222 tracked releases carry eBay sold comps, and 214 clear five sold each, a 96 percent coverage rate. The median of those 214 release medians is $15.50, and it is per release: our comps do not split loose from carded. Sixty of those releases sit at $20 or more, and six clear $50. Exactly one, a spaceship, reaches $100.' },
      { type: 'h2', text: 'The cardback spread tops out near five dollars' },
      { type: 'p', text: 'Sort by card and the range across six single-figure packaging eras is narrower than the full catalog. Red (1995–96): $14.95 across 27 sampled figures, all with five-plus sales. Green (1997): $12.00 across 47, counting both spellings our catalog uses for that wave’s name; one spelling alone undercounts it by two. That split is our bookkeeping, not Hasbro’s. Freeze Frame: $16.15 across 18, the highest of the six, from the middle of the run. Starburst, the CommTech and Flashback cards: $11.00 across 20, the newest card and the cheapest. Expanded Universe: $16.00 across 9. Shadows of the Empire: $14.68 across 5, the thinnest cohort we’ll quote here. Boxed exclusives and deluxe packs run separately, and higher, at $17.10 across 51. Red, the oldest card, and starburst, the newest, are $3.95 apart, but Freeze Frame sits about a dollar above red and stretches the spread to $5.15.' },
      { type: 'h2', text: 'Fifteen dollars, fifty times' },
      { type: 'p', text: 'The red-card Boba Fett holds a $15 median across a full 50 sold, with a $999 top sale so far above the rest of the range it reads as an outlier we haven’t checked, not the market. R2-D2’s red-card release holds at $40.50, nearly triple Fett’s number, across only 20 sold, two-fifths of Fett’s sample size. Our catalog can’t tell you why R2-D2 carries a premium and Fett doesn’t; cardback printings and accessory revisions aren’t in our data. Fett’s 50-sale sample isn’t unique to him, either: forty-seven other single-figure releases here cap at exactly 50 sold, including C-3PO, Ben Kenobi, and three different Luke Skywalker releases on the red card alone. That looks like a retrieval ceiling on our side, not a market fact.' },
      ...
      { type: 'p', text: 'More of the red card, all at n=20 or more: Greedo $23 across 20, Tusken Raider $22 across 28, the buff Luke Skywalker $20.27 across 27. Yoda $18, Vader $17.15, Han Solo $17.10, Chewbacca $17, Jawas $17, Stormtrooper $16, all across 20. Lando $14.99 across 26, R5-D4 $14.95 across 50, C-3PO $14.39 across 50. Twenty-seven figures on this card, and only one of them, R2-D2, clears $25.' },
      { type: 'h2', text: 'A driver our data can’t explain' },
      { type: 'p', text: 'The Freeze Frame AT-AT Driver, dated 1998 in our catalog, holds $75 across 20 sold with a $245 top sale: the only carded single among all 214 releases at five-plus sales priced above $50. Nothing in our data explains why a Freeze Frame driver outprices nearly every other single by three to five times. We carry no case-ratio or shipping data, so we won’t guess how deep Hasbro shipped this release. What we can say is the number: $75, twenty times, one outlier among the carded singles.' },
      ...
      { type: 'p', text: 'Boxes, not cards, hold this line’s real money. Vehicles, creatures, and playsets carry a median of $27 across 37 releases, all at five-plus sales, against $11 to $16 for carded singles, and fifteen of the 37 sit at $30 or more. Five of the six releases that clear $50 are boxes; the sixth is the AT-AT Driver on a card. Dash Rendar’s Outrider tops the chart at $100 on only 6 sold; the 1996 Shadows of the Empire boxing of the same ship sells for $25.65 across 22, so read that $100 as a thin-sample number, not a settled price. The Imperial AT-AT Walker is the top of the line with a sample that holds up: $95 across 28 sold, top $224.99. Only two vehicles carry a full 50-sale sample above $60, the Y-Wing Fighter at $79.99 and the X-Wing Fighter at $65.55.' },
      ...
      { type: 'p', text: 'Below those: Rancor with Luke $69.35 across 21, the Millennium Falcon CD-ROM playset $48.88 across 50, the AT-ST Scout Walker $46.44 across 50 with an $874.99 outlier sale we haven’t checked, Slave I in its Shadows of the Empire box $45.99 across 28 against $36.10 across 18 for the standard release, and Bantha with Tusken Raider $45 across 20. The exclusives bucket, $17.10 across 51 releases overall, carries vehicle-shaped pieces at similar money too: the Gunner Station two-packs run $30 to $39.99 on full 50-sale samples, and the Walmart-exclusive Max Rebo Band pairs top out at $49.99 across 24. The 1995 Rebel Snowspeeder sits at $34 across 50, respectable but not a floor. The Imperial Speeder Bike ($11/50) and the Death Star Escape Playset ($21.03/50) are both cheaper 1995 boxes in the same catalog.' },
      { type: 'callout', text: 'Year medians, where a year exists: 1995 $17.15 across 19, 1996 $19.00 across 18, 1997 $15.50 across 32, 1998 $20.00 across 30, 1999 $31.87 across a thin 6. Five of those six 1999 releases are boxes, which is most of why the number jumps; it reflects which releases carry a year in our catalog, not a market trend. 116 of the 222 releases here carry no year at all, which is why card color does more work above than the calendar does.' },
      { type: 'h2', text: 'Four pairs, one price' },
      { type: 'p', text: 'Four pairs of releases share one sold sample in our catalog, so eight releases carry four prices. Three are Luke Skywalker pairs: Dagobah Fatigues and Stormtrooper Disguise both read $11.24 across 50, Hoth Gear and the green-card Stormtrooper Disguise both read $11.99 across 50, Jedi Knight and X-Wing Pilot Gear both read $12.98 across 50. That’s 6 of Luke’s 14 releases sharing only three prices. The fourth is a Speeder Bike pair at $15 across 50. Mara Jade and Ree-Yees share a $20 median, but their minimum and average sales differ, so the match is a coincidence. We don’t track cardback printings or saber-length changes, so we can’t confirm or rule out any “variant” premium.' },
      { type: 'p', text: 'A carded Power of the Force figure is an $11-to-$16 object depending on card color, with exactly one carded single over $50, at $75. A boxed vehicle is a different category, and the only two with a full 50-sale sample above $60 are the Y-Wing and the X-Wing. Pay up to $79.99 for the Y-Wing or $65.55 for the X-Wing on that 50-sale history, and treat the Outrider’s $100 as a six-sale rumor, not a price. Skip the Fett premium: $15 is his price, and the $999 is one sale.' },
      { type: 'h2', text: 'Further reading' },
      { type: 'ul', items: [
        '[[Most valuable vintage Kenner Star Wars figures|/guides/most-valuable-vintage-star-wars-kenner]]: the 1977–85 line this one revived, where the big money is',
        '[[Star Wars Vintage Collection price guide|/guides/star-wars-vintage-collection-price-guide]]: the 2010-on Kenner-homage line',
  ...
  },
  {
    ...
    dek: 'Our Toy Biz catalog carries Sting across 28 comp\'d releases in four years. Twenty-six of them return the exact same number. Here is what that collapse means for the rest of the line.',
    readingMinutes: 6,
    updated: '2026-09-12',
    shortVersion:
    ...
    body: [
      { type: 'p', text: 'Toy Biz\'s WCW releases in our catalog run from 1998 to 2001: the same handful of names under one sub-line after another. Bashin\' Brawlers with a spring-loaded torso slam, Body Bashers plush buddies, Keychain Wrestlers, Grip N Flip two-packs, 12-inch Tuff Talkin electronics, Bruisers, Smash \'N Slam, Slam N Crunch.' },
      { type: 'p', text: '209 of those releases sit in the catalog across 51 sub-series codes, most without a real name beyond a two-to-four-letter checklist tag. Comps exist for 149; 135 clear five sold. The median across those 135 is $22.99, and 76 of them, 56 percent, land between $20 and $30 inclusive. Exactly one release clears $50 at a usable sample size, and it\'s a box with three names in it, not a single figure.' },
      { type: 'h2', text: 'Twenty-six Stings, one number' },
      { type: 'p', text: 'Toy Biz kept going back to the same names, and Sting is the worst offender: 28 comp\'d releases, spanning four years, 1998 through a 2001 multi-figure box. Twenty-six return the identical snapshot: $24.97 median, 20 sold, $135.50 high, every decimal matching. The other two are real numbers: a 1998 Brawler at $20 across a full 50 sold, and a three-sale reading on a box of six bendable figures (Sting, Goldberg, DDP, Hall, Steiner, Nash) at $50, too thin at n=3 to trust. Goldberg is the same shape: 27 comp\'d releases, 26 locked to $13.95 across 18 sold, one Brawler exception at $15 across 50. That collapse is a flaw in how we match sold comps to releases: one wrestler\'s sales get attached to every sub-series code that wrestler appears in, which is why this page prices names, not release codes. The 149 comp\'d releases carry 36 distinct medians and 51 distinct sets of comp numbers once all five fields are compared.' },
      { type: 'h2', text: 'What a Toy Biz name is worth' },
      { type: 'p', text: 'Where a wrestler has several releases, most of them share a single sold-comp number, and "pool to" below means exactly that: the same median and sold count on each release, so a pooled figure is the price of the name.' },
      { type: 'ul', items: [
        ...
        'Scott Steiner: three releases pool to $24.95 across 20; a fourth, the 12-inch Tuff Talkin release, runs $21.95 across a full 50 sold.',
        'Randy Savage: six of his seven comp\'d releases here are identical at $22.99 across 20 sold; the seventh matches to the cent but shows 22 sold, not 20, about as close to one honest number as this line gets.',
      ...
      { type: 'p', text: 'Many of the unpooled exceptions above cap at exactly 50 sold, among them Sting\'s and Goldberg\'s Brawlers, Hogan\'s and DDP\'s Body Bashers, Giant and Steiner\'s Tuff Talkin. That is a ceiling on how many sales our data pull returns, not proof that exactly 50 changed hands. Konnan\'s 35, Vampiro\'s 31, Sid\'s 46 and Bagwell\'s 45 stopped short of that cap on their own, the rarer, more literal count. A sold-comp snapshot tells you which number is bigger, not how big the underlying market is, and it does not split loose from carded.' },
      { type: 'h2', text: 'The boxes that actually stand alone' },
      { type: 'p', text: 'The Hollywood Hogan, Goldberg and Sting 3-pack from 1999 medians $109.99 across 7 sold, top $199.95, the only release in the whole n≥5 tier over $50. A thinner number sits above it: a Scott Steiner, Sid Vicious and Kidman 3-pack at $249.99 on one sale, a price, not a market. Sting versus Hollywood Hogan, a 1999 Clash of the Champions two-pack, holds $40 across 7; a second Sting/Hogan pairing, in Body Bashers plush, has only two sales at $38.99, too thin to trust. Giant versus Kevin Nash, 1999, runs $32.99 across 10. Macho Man Randy Savage\'s Keychain Wrestlers release (our catalog notes call it that, not "Series 1") holds $30 across a full 50 sold, with one sale at $500 on a small non-articulated PVC clip-on, an unreviewed high outlier, not a second price point. Kidman\'s two releases, $30 across 15 and $30 across 8, match by coincidence: the sold counts and averages differ, so pooling doesn\'t explain it.' },
