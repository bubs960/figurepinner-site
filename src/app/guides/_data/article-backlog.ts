...
export const BACKLOG: BacklogIdea[] = [
  ...
  { id: 8, title: 'How to Price a Figure With Almost No Sold Comps', slug: 'pricing-thin-comp-figures', angle: 'Thin-market volatility, adjacent comps, condition laddering. The hardest pricing case.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 9, title: 'Chase Variants Explained: Odds, Value, and How to Spot Them', slug: 'chase-variants-explained', angle: 'Pack ratios, how to authenticate a chase, why deco-only chases get faked.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 10, title: 'When to Buy a Figure and When to Wait', slug: 'when-to-buy-or-wait', angle: 'Release-day premiums, reissue risk, seasonal price dips, the post-holiday glut.', track: 'cross-genre', priority: 1, status: 'published' },
  ...
  { id: 12, title: 'How to Spot a Reissue Before You Overpay', slug: 'spot-a-reissue', angle: 'The single biggest modern-figure value killer. Reading Hasbro/Mattel reissue signals.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 13, title: 'Accessories and Why They Make or Break a Figure\'s Price', slug: 'accessories-and-figure-value', angle: 'Loose-incomplete = 30-50% of complete. Which accessories carry the money.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 14, title: 'How to Build a Collection on a Budget', slug: 'collecting-on-a-budget', angle: 'Pick a lane, buy the floor, patience over FOMO. Anti-burnout collecting.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 15, title: 'Grading and Condition: What Collectors Actually Care About', slug: 'how-action-figure-conditions-are-graded', angle: 'Why figures don\'t use card-style numeric grading; the loose/complete/MOC/sealed ladder. Renamed 2026-08-02 from condition-grading-for-collectors (webaudit A1 Bing-earning-orphan map); old slug 301s in next.config.ts.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 42, title: 'Is AFA Grading Worth It? When to Pay, When to Skip It', slug: 'afa-grading-action-figures-worth-it', angle: 'Bing-earning orphan recovery 2026-08-02 (webaudit A1). When the grading fee clears vs wastes money.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 43, title: 'The Most Valuable Wrestling Action Figures — Across Every Era', slug: 'most-valuable-wrestling-action-figures', angle: 'Bing-earning orphan recovery 2026-08-02 (webaudit A1). Distinct intent from most-valuable-vintage-wrestling-figures (all-era, not vintage-only).', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 44, title: 'The Most Valuable Action Force Figures', slug: 'most-valuable-action-force-figures', angle: 'Bing-earning orphan recovery 2026-08-02 (webaudit A1). UK Palitoy G.I. Joe line + Valaverse revival.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 45, title: 'The Most Valuable G1 Transformers', slug: 'most-valuable-g1-transformers', angle: 'Bing-earning orphan recovery 2026-08-02 (webaudit A1). G1-specific, distinct from transformers-collecting-guide (3-line comparison).', track: 'cross-genre', priority: 1, status: 'published' },

  // ───────────────────────── TIER 2 — LINE / GENRE INTROS (SEO breadth) ─────────────────────────
  { id: 16, title: 'Transformers Collecting: Masterpiece vs Studio Series vs Generations', slug: 'transformers-collecting-guide', angle: 'Three lines, three buyers, three price tiers. Where a beginner starts.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 17, title: 'G.I. Joe Classified vs A Real American Hero: Which to Collect', slug: 'gi-joe-classified-vs-arah', angle: 'Modern 6-inch vs vintage 3.75. Two completely different markets and collectors.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 18, title: 'Masters of the Universe: Origins, Masterverse, and Vintage MOTU', slug: 'motu-collecting-guide', angle: 'The nostalgia engine of the 80s, three modern entry points, vintage value drivers.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 19, title: 'NECA Ultimate Line: A Horror and Film Collector\'s Starting Point', slug: 'neca-ultimate-starter-guide', angle: 'Why NECA owns horror/movie figures; what makes an Ultimate worth it.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 20, title: 'McFarlane DC Multiverse: The Budget Superhero Line Explained', slug: 'mcfarlane-dc-multiverse-guide', angle: 'Cheap, deep, divisive QC. What holds value and what pegwarms.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 21, title: 'TMNT Collecting: NECA, Playmates Vintage, and Super7', slug: 'tmnt-collecting-guide', angle: 'Vintage Playmates nostalgia vs NECA premium vs Super7 ReAction.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 22, title: 'Star Wars Vintage Collection vs Black Series: Which Is For You', slug: 'swvc-vs-black-series', angle: '3.75 carded nostalgia vs 6-inch premium. The two pillars of SW collecting.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 23, title: 'Power Rangers Lightning Collection: A Collector\'s Guide', slug: 'power-rangers-lightning-collection-guide', angle: 'The line that finally treated Rangers as collector figures. Value drivers + exclusives.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 24, title: 'Spawn Figures: From McFarlane\'s 1994 Revolution to Today', slug: 'spawn-figures-guide', angle: 'The line that invented the adult-collector category. Vintage Series 1-35 value.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 25, title: 'Mythic Legions: Why Four Horsemen Figures Hold Value', slug: 'mythic-legions-guide', angle: 'Modular, crowdfunded, scarcity-by-design. The collector-economics case study.', track: 'cross-genre', priority: 2, status: 'published' },
  ...
  { id: 31, title: 'WWE Elite Series Numbers That Are Worth the Most', slug: 'valuable-wwe-elite-series', angle: 'Early series, chase variants, retired exclusives. Which Elites buck the cheap-floor rule.', track: 'wrestling', priority: 2, status: 'published' },
  { id: 32, title: 'Jakks Ruthless Aggression vs Deluxe Aggression: A Value Guide', slug: 'jakks-aggression-value-guide', angle: 'The bridge-generation figures now climbing. Name-dependent value.', track: 'wrestling', priority: 2, status: 'published' },
  { id: 33, title: 'Hasbro WWF Figures: The Complete Era Value Breakdown', slug: 'hasbro-wwf-value-breakdown', angle: 'Early vs late series print runs; European exclusives; the action-feature line.', track: 'wrestling', priority: 2, status: 'published' },
  { id: 34, title: 'LJN WWF: The Rubber Giants and What Clean Ones Cost', slug: 'ljn-wwf-value-guide', angle: 'Condition is the whole comp. The Hulkamania nostalgia engine.', track: 'wrestling', priority: 2, status: 'published' },
  ...
  { id: 101, title: 'Hope Summers Marvel Legends: The Mutant Messiah Figure You Probably Overpaid For', slug: 'hope-summers-marvel-legends-figure-guide', angle: 'Terrax wave 2012, BAF completionism pricing, Krakoa-era demand driver, no MCU bump means no reissue flood.', track: 'cross-genre', priority: 2, status: 'published' },
  { id: 102, title: 'Marvel Legends Price Guide 2026', slug: 'marvel-legends-price-guide-2026', angle: 'Toy Biz vs Hasbro era values, BAF economics, Walgreens exclusives, HasLab comps.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 103, title: 'Most Valuable WWE Elite Figures', slug: 'most-valuable-wwe-elite-figures', angle: 'RSC exclusives, rights-lapsed legends, True FX scarcity paradox, what actually holds value.', track: 'wrestling', priority: 1, status: 'published' },
  { id: 104, title: 'How to Find What Your Action Figures Are Worth', slug: 'how-to-find-action-figure-values', angle: 'Sold comps vs listings, condition tiers, reading price history, fast valuation framework.', track: 'cross-genre', priority: 1, status: 'published' },
  { id: 105, title: 'Ultimate Warrior Figures: A Megastar With a Bargain-Bin Price', slug: 'ultimate-warrior-figure-value', angle: 'Fame vs value: real sold comps show the Warrior is common and cheap ($11 Hasbro / $20 Elite); where the rare exceptions actually hide.', track: 'wrestling', priority: 2, status: 'published' },
  { id: 106, title: 'Tully Blanchard Figures: When a Horseman Out-Prices the Headliners', slug: 'tully-blanchard-figure-value', angle: 'Scarcity beats fame: Jakks Classic Superstars S15 ($38/16 sold) out-medians a modern Warrior Elite; the non-headliner value case study.', track: 'wrestling', priority: 2, status: 'published' },

]

// Helper the daily routine uses: next N ideas not yet dr