...
export const BACKLOG: BacklogIdea[] = [
  ...
  { id: 15, title: 'Grading and Condition: What Collectors Actually Care About', slug: 'condition-grading-for-collectors', angle: 'Why figures don\'t use card-style numeric grading; the loose/complete/MOC/sealed ladder.', track: 'cross-genre', priority: 1, status: 'published' },
